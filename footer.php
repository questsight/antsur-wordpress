            ...
            <footer class="site__footer footer">
                <div class="footer__wrapper">
                    ...
                    <div class="social">
                        ...
                        <div class="social__item">
                            <a href="https://vk.com/mitrasfund" target="_blank"><i class="fa fa-vk" aria-hidden="true"></i></a>
                        </div>
                        <div class="social__item">
                            <a href="https://www.instagram.com/ant.sur/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                        </div>
                    </div>
