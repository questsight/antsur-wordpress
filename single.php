<?php get_header();
  ...
  while ( have_posts() ) : the_post();
    ...
    else if (in_category('texts') || in_category('tekstyi') || in_category('encounters') || in_category('vstrechi') || in_category('tekstyi-ru') || in_category('texts-en') || in_category('publikaczii')) {
