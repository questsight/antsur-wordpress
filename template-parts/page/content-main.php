<div class="main">
  ...
  <h1 class="page__title text-center">Our partners</h1>
  <?php else: ?>  
  <h1 class="page__title text-center">Наши партнёры</h1>
  <?php endif; ?>
    <div class="container">
      <div class="main__partners">
        <?php $fields = CFS()->get( 'partners' );
          if( ! empty($fields) ):
            foreach ( $fields as $key => $val ):?>
        <a href="<?php echo $val['link'];?>" target="_blank"><img src="<?php echo $val['img'];?>"></a>
